...
// 1. Updated the type definition for params (must be a Promise in Next.js 15)
export async function GET(
  ...
  try {
    ...
    console.error("Category API error:", err);
    // 3. Fix: Ensure a proper NextResponse is returned
    const errorResponse = handleError(err, "api");
