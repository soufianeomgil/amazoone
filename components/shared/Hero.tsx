              ...
              px-6 md:px-20 pb-16 md:pb-0 pointer-events-none">
                <div className="max-w-2xl text-white pointer-events-auto">
                    ...
                    <div className="flex gap-4 mt-8">
                        <Link
                            href="/category/bags"
                            className="bg-yellow-400 text-black px-8 py-3 rounded-sm font-bold
                             uppercase tracking-wider whitespace-nowrap hover:bg-yellow-500 transition-colors shadow-lg"
                        >
                            Shop Bags
                        </Link>
                        <Link
                            ...
                            className="bg-white/10 backdrop-blur-md border border-white/30
                             text-white px-8 py-3 rounded-sm font-bold uppercase tracking-wider hover:bg-white/20 transition-all"
                        >
                            Discover
                        </Link>
                    </div>
