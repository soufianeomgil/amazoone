...
export const ChevronLeftIcon: React.FC<{ onClick?: () => void }> = ({ onClick }) => (
    <svg onClick={onClick} xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const StarIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-3 w-3"} viewBox="0 0 20 20" fill="currentColor">
...
export const LockClosedIcon: React.FC<{className?: string}> = ({ className = "h-4 w-4" }) => (
...
export const ChevronRightIcon: React.FC<{ onClick?: () => void }> = ({ onClick }) => (
    <svg onClick={onClick} xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
//         <path fillRule="evenodd" clipRule="evenodd" d="M0 0H21V8H0V0Z" fill="#002868"/>
//         <path fillRule="evenodd" clipRule="evenodd" d="M0 0V8H11V0H0ZM1.5 1.5H9.5V6.5H1.5V1.5Z" fill="#BF0A30"/>
//         <path d="M0 2H21V3H0V2ZM0 4H21V5H0V4ZM0 6H21V7H0V6Z" fill="#BF0A30"/>
//         <path d="M0 8H21V9H0V8ZM0 10H21V11H0V10ZM0 12H21V13H0V12ZM0 14H21V15H0V14Z" fill="#BF0A30"/>
//         <path fillRule="evenodd" clipRule="evenodd" d="M1.5 1.5H9.5V6.5H1.5V1.5Z" fill="#002868"/>
//         <path fillRule="evenodd" clipRule="evenodd" d="M2.5 2.5H8.5V5.5H2.5V2.5Z" fill="white"/>
//     </svg>
// );
...
export const UpDownArrowsIcon: React.FC = () => (
     <svg className="h-4 w-4 text-gray-400 ml-1 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7l4-4 4 4m0 10l-4 4-4-4"></path>
    </svg>
);
